...
## 4.注释
```shell
perl /home/caominghao/software/21.ANNOVAR/annovar/annotate_variation.pl -out gwas -build pig gwas.avinput /home/caominghao/software/21.ANNOVAR/annovar/pig/
```
## 5.将vcf文件转为annovar格式
```shell
